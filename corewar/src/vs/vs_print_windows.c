...
/*   Updated: 2019/08/02 16:23:33 by jwinthei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	mvwprintw(cw->vs.bkg, 68, 125, "%s", "MENU");
	mvwprintw(cw->vs.bkg, 70, 15, "%s", "Exit: 'esc'");
	mvwprintw(cw->vs.bkg, 70, 55, "%s", "Start/Pause: 'space'");
	mvwprintw(cw->vs.bkg, 70, 95, "%s", "Step by step mode: 's'");
	mvwprintw(cw->vs.bkg, 70, 135, "%s", "Speed x10: 'w' | 'e'");
	mvwprintw(cw->vs.bkg, 70, 175, "%s", "Speed x50: 'q' | 'r'");
	mvwprintw(cw->vs.bkg, 70, 225, "%s", "Audio: 'a'");
...
void			vs_print_windows(t_cw *cw)
{
	...
	wrefresh(cw->vs.bkg);
	if (cw->f.lg.af)
		mvwprintw(cw->vs.bkg, 72, 125, "%s", "AFF");
}
